#!/usr/bin/env bash
# dsh-session-archive-manager — one-shot installer for DeepSeek Harness Desktop
#
...
# ---- per-plugin config ------------------------------------------------------
REPO="my-dsh-plugin/session-archive-manager"
BRANCH="main"
PLUGIN_NAME="dsh-session-archive-manager"
WHITELIST_NS="session-archive-manager"   # settings namespace; empty => skip allowlist patch
